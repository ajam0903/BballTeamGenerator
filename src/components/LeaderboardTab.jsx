                        ...
                        <table className="min-w-full divide-y divide-gray-700">
                                <thead className="bg-gray-800 sticky top-0 z-10">
                                    <tr>
                                        {/* Fixed columns */}
                                        <th
                                            className="px-2 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider sticky left-0 bg-gray-800 cursor-pointer border-r border-gray-900"
                                            onClick={() => handleSort("name")}
                                        >
                                            Player {sortBy === "name" && (sortDirection === "asc" ? "▲" : "▼")}
                                        </th>
                                        <th
                                            className="px-1 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer min-w-[10px] whitespace-nowrap border-r border-gray-900"
                                        ...
                                        {/* Record columns */}
                                        <th
                                            className="px-1 py-3 text-center text-xs font-medium text-gray-300 uppercase tracking-wider cursor-pointer border-r border-gray-900"
                                ...
                                <tbody className="divide-y divide-gray-700 bg-gray-900">
                                    {sortedData.map((player, index) => (
                                        <tr key={player.name} className={index % 2 === 0 ? "bg-gray-900" : "bg-gray-800"}>
                                            {/* Fixed column */}
                                            <td className="px-2 py-3 whitespace-nowrap text-sm font-medium text-white sticky left-0 z-5 bg-inherit text-center border-r border-gray-900">
                                                {formatPlayerName(player.name)}
                                            </td>

                                            <td className="px-1 py-3 whitespace-nowrap text-sm text-white text-center border-r border-gray-900">
                                            ...
                                            {editingPlayer === player.name ? (
                                                <>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-center border-r border-gray-900">
                                                        <StyledInput
                                                            type="number"
                                                    ...
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-blue-400 text-center border-r border-gray-900">
                                                    ...
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-gray-300 text-center border-r border-gray-900">
                                                        {player.last10Record}
                                                    </td>
                                                </>
                                            ) : (
                                                <>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-green-400 text-center border-r border-gray-900">
                                                        {player.wins}
                                                    </td>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-red-400 text-center border-r border-gray-900">
                                                        {player.losses}
                                                    </td>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-blue-400 text-center border-r border-gray-900">
                                                        {player.pct}%
                                                    </td>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-yellow-400 text-center border-r border-gray-900">
                                                        {player.mvps}
                                                    </td>
                                                    <td className="px-1 py-3 whitespace-nowrap text-sm text-gray-300 text-center border-r border-gray-900">
                                                        {player.last10Record}
